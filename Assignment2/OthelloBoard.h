...
public:
    ...
    void set_utility_value(int ut) { utilityValue = ut; }

    int get_utility_value() { return utilityValue; }

    void set_last_move(int c, int r) { last_move_col = c; last_move_row = r; }

    int get_last_move_col() { return last_move_col; }

    int get_last_move_row() { return last_move_row; }
